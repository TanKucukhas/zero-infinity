...
const LoginPage = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center min-h-screen relative p-6 bg-gray-50 dark:bg-zinc-950'>
      {/* Theme Toggle */}
      ...
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-glow dark:bg-zinc-900 dark:text-zinc-100">
        ...
        <form noValidate autoComplete='off' onSubmit={handleSubmit} className='flex flex-col gap-5'>
          ...
          <div className='flex justify-center items-center flex-wrap gap-2'>
            <span className="text-gray-500 dark:text-zinc-400">New to our platform?</span>
